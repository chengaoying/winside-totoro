...
public interface Common {
	...
	/*角色状态1*/
	public static final int ROLE_ALIVE = 1;		//活着状态
	public static final int ROLE_DEAD = -1;		//死亡转台	
	public static final int ROLE_PROTECTED = 2;	//无敌状态
	public static final int ROLE_PASS = 3;		//通关状态
	
	/*角色状态2*/
	public static final int ROLE_MOVE = 1;			//移动状态
	public static final int ROLE_ATTACK = 2;		//普通攻击状态
	public static final int ROLE_SKILL_ATTACK = 3;	//技能攻击状态
	...
	public int bossParam[][] = {
			 ...
			 * 9-图片id, 10-帧数间隔, 11-图片总帧数, 12-伤害, 13-发射子弹间隔, 14-方向, 15-初始位置, 16-状态2*/
