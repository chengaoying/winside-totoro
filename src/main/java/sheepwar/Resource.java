...
public class Resource implements Common {
	...
	public static String propIntroduce [][]= {
		{"时光钟:#r时间静止10秒。#r 价格：2游戏币","驱狼竖琴:#r使用后清除所有梯子上或者正在推石头的灰太狼。#r价格：3游戏币"},//shopY
		{"捕狼网:#r发射出的子弹碰到灰太狼就会张开一张网，#r大网内的灰太狼都会掉落。#r只击落碰到的灰太狼。#r价格：2游戏币","速度提升液:#r使用后增加喜羊羊的移动速度，持续30秒。#r价格：3游戏币"},
		{"防狼套装:#r开启后得到5秒的无敌效#r果，抵御各种攻击。#r价格：3游戏币","强力磁石:#r击落所有空中的灰太狼。#r价格：5游戏币"},
		{"驱狼光波:#r发出一道十万伏特的电流，电晕碰到的灰太狼，持续5秒。#r价格：3游戏币","替身玩偶:#r增加一条命。#r价格：5游戏币"},
	};
