...
public class Resource implements Common {
	...
	public static String propIntroduce [][]= {
		...
		{"捕狼网:#r发射出的飞镖碰到灰太狼就会张开一张网,大网内的灰太狼都会掉落#r价格：20","连发:#r使用后连续发射四颗飞镖，单关有效#r价格：30"},
		{"防狼套装:#r开启后得到30秒的无敌效果，抵御各种攻击#r价格：30","强力磁石:#r击落所有空中的灰太狼#r价格：50"},
		{"驱狼光波:#r发出一道十万伏特的电流，电晕碰到的灰太狼，持续5秒#r价格：30","替身玩偶:#r增加一条命#r价格：50"},
	};
