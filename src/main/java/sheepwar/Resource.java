...
public class Resource implements Common {
	...
	public static String gameInfo[] = {   
		...
		"【道具说明】#r时光闹钟：时间静止10秒#r捕狼网：发射一张大网网住灰太狼#r防狼套装：使用后抵抗子弹的攻击#r替身玩偶：增加一条命#r驱狼竖琴：可以清除成功降落的灰太狼#r连发:装备后一次可以发射4个飞镖#r强力磁石：击落所有空中的灰太狼#r驱狼光波：发射一道光波击落灰太狼",
	...
	public static String propIntroduce [][]= {
		...
		{"捕狼网:发射出的子弹碰到灰太狼就会张开一张网，大网内的灰太狼都会掉落。只击落碰到的灰太狼。#r价格：20","连发:使用后连续发射四颗子弹，单关有效。#r价格：30"},
		{"防狼套装:开启后得到5秒的无敌效果，抵御各种攻击。#r价格：30","强力磁石:击落所有空中的灰太狼。#r价格：50"},
